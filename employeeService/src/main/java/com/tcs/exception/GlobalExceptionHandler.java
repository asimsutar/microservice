...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<ErrorInfo> handlerEmployeeNotFoundException(EmployeeNotFoundException exception){
	...
	@ExceptionHandler(value = LaptopAlreadyAssignedException.class)
	public ResponseEntity<ErrorInfo> HandlerLaptopAlreadyAssignedException(LaptopAlreadyAssignedException exception){
		ErrorInfo errorInfo = new ErrorInfo();
		errorInfo.setMessage(exception.getMessage());
		errorInfo.setLocalDateTime(LocalDateTime.now());
